                ...
                <form class="form fv-plugins-bootstrap5 fv-plugins-framework" method="post" action="{{ $action }}" enctype="multipart/form-data">
                    ...
                    <div class="card-body border-top p-9">
                        ...
                        <div class="row mb-6">
                            ...
                            <!--begin::Col-->
                            <div class="col-lg-8">
                                <input type="text" name="username" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Full name" value="{{ $data["username"] }}">
        ...
        <div class="col-lg-3 mb-xl-10">
            ...
            <x-card>
                ...
                <x-card.header>
                    ...
                    <!--begin::Card toolbar-->
                    <x-card.toolbar>
                        <div class="rounded-circle w-15px h-15px bg-primary bg-{{ $data['status'] == 'active' ? 'success' : 'danger' }}"></div>
                    </x-card.toolbar>
                    <!--begin::Card toolbar-->
                </x-card.header>
                <!--end::Card header-->
